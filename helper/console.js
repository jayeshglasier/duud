...
exports.error = (message, filePath, requestUrl) => { //console.error('test error', __filename, '/req.originalUrl')
...
exports.logs = (message, filePath, requestUrl) => { //console.logs('test log', __filename, '/req.originalUrl')
